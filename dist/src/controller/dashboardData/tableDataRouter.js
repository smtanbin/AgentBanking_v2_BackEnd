...
tableDataRouter.get("/pendingEvent", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tableData.PendingEvent()];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
tableDataRouter.get("/event", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.default = tableDataRouter;
