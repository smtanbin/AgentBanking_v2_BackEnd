...
var customerModel_1 = __importDefault(require("../../model/Models/customerModel/customerModel"));
var customerRouter = express_1.default.Router();
var customer = new customerModel_1.default();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, customer.search(params)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
customerRouter.post("/getImage", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, customer.photo(params)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
customerRouter.post("/getImageData", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, customer.imageData(params)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, customer.get(params)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
